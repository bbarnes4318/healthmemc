...
import { Bell, BellRing, Clock, Pill, CheckCircle, Loader2, AlertCircle, Info } from "lucide-react";
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border ${
                    isDueNow ? "bg-amber-50 border-amber-300" : isPast ? "bg-gray-50 border-gray-200 opacity-60" : "bg-white border-border"
                  }`}
                >
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${isPast ? "bg-gray-100" : "bg-amber-100"}`}>
                    <Pill className={`w-4 h-4 ${isPast ? "text-gray-400" : "text-amber-600"}`} />
                  </div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {isPast ? "Passed" : isDueNow ? "Due now" : "Upcoming"}
                    </p>
                  </div>
                </div>
              );
