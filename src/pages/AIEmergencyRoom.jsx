...
import { Siren, HeartPulse, Brain, Bone, Wind, Shield, Pill, LayoutDashboard } from "lucide-react";
      ...
      <div className="sticky top-14 lg:top-0 z-10 bg-white border-b border-border px-4 py-2">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-2 max-w-md mx-auto">
            ...
            <TabsTrigger value="consult"><Siren className="w-3.5 h-3.5 mr-1.5" />AI Consult</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
      {activeTab === "dashboard" ? (
