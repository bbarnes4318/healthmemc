    ...
    <div className="p-4 lg:p-8 max-w-3xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-2 sm:grid-cols-[repeat(13,minmax(0,1fr))] mb-6 overflow-x-auto">
            ...
            <TabsTrigger value="weight-dose"><Calculator className="w-3.5 h-3.5 mr-1" />Wt. Dose</TabsTrigger>
